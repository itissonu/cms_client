            ...
            <div className='w-[92%] h-[90%] flex flex-col gap-10 bg-white overflow-y-auto overflow-hidden custom-scrollbar rounded-lg shadow-md'>
                <div className='flex flex-col w-full'>
                    ...
                    <div className='flex justify-between items-center p-5'>
                        <button className=' hover:bg-orange-600 hover:text-white h-max rounded-md shadow-sm hover:border-none p-3 uppercase text-lg  font-bold text-gray-900 items-center w-1/3 border-[1px] border-gray-400' >Published</button>
                        <div className='w-1/4 hover:border-none  flex flex-col items-center border-b-2 p-6 rounded-full shadow-md border-sky-300'> <FiPlusCircle className='hover:cursor-pointer p-1 h-10 w-10  shadow-gray-700 text-green-400' /><span className=' text-blue-300 text-xs font-bold m-1 uppercase'>Add Post</span></div>
                        <button className=' hover:bg-orange-600 hover:text-white hover:border-none h-max rounded-md  p-3 border-[1px]   border-gray-200 w-1/3 uppercase text-lg font-bold text-gray-900' >Draft</button>
                    </div>
                    <div className='flex flex-wrap min-h-screen '>
                        {blogs.map((blog, indx) => (
                            <div key={indx} className='hover:cursor-pointer w-[32%] gap-2 h-[450px] p-2 m-1 flex flex-col rounded-md items-center border-[1px] border-gray-50 shadow-md hover:shadow-sky-100 '>
                                ...
                                <div className='flex flex-col max-w-full w-full'>
                                    ...
                                    <p className='my-2 text-sm text-gray-900 text-wrap max-w-xs line-clamp-3 truncate'>
                                        {blog.content}
                                    </p>
